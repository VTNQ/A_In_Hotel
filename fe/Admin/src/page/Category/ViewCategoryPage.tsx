    ...
    <div className="flex flex-col flex-1">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 text-white bg-[#42578E] rounded-lg hover:bg-[#536DB2] transition-colors"
        >
          {t("category.new")}
        </button>
      </div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-3 mb-4">
        ...
        <div
          className="flex w-full lg:w-[220px] h-11 border border-[#C2C4C5] dark:border-slate-700 rounded-lg overflow-hidden bg-white
        ...
        >
          ...
          <select
            ...
            className="flex-1 py-2.5 pl-3 pr-8 text-gray-700 dark:text-gray-100 text-sm bg-white dark:bg-slate-900 focus:outline-none"
          >
            <option value="">{t("common.all")}</option>
