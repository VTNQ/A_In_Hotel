 ...
 return (
  <div
    className={`
      ...
      ${selected
        ? "border-[#536DB2] dark:border-blue-400"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
          ...
          <div className="sm:text-right">
            <div className="text-lg sm:text-xl font-semibold text-[#536DB2] dark:text-blue-400">
              ${priceInfo.price}
            </div>
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            className={`
              ...
              ${
                selected
                  ? "border-gray-300 bg-white text-gray-800 focus:outline-none focus:ring-1 focus:ring-[#536DB2] dark:bg-gray-900 dark:border-gray-600 dark:text-gray-100"
            ...
            className={`
              ...
              ${
                selected
                  ...
                  : "border border-[#536DB2] text-[#42578E] dark:border-blue-400 dark:text-blue-300"
              }
            `}
          >
            {selected
