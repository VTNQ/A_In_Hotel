...
return (
  <div className="fixed inset-0 z-50 bg-black/50 dark:bg-black/70 flex items-center justify-center">
    ...
    ">
      ...
      {/* ================= LOADING ================= */}
      {loading && (
        <div className="absolute inset-0 z-20 bg-white/70 dark:bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center">
          <div className="w-10 h-10 border-4 border-slate-200 dark:border-slate-700 border-t-[#1D263E] rounded-full animate-spin" />
          <p className="mt-4 text-sm text-[#5f6b85] dark:text-gray-300">
            {t("common.loading")}
          </p>
        </div>
      )}
      ...
      {/* ================= TABS ================= */}
      <div className="flex-1 overflow-y-auto custom-scroll bg-white dark:bg-[#111827]">

        <div className="
          px-6 pb-1 pt-3 flex gap-6 border-b
        ...
        ">
          <button
            ...
            className={`pb-3 border-b-2 transition
              ${
                activeTab === "guest"
                  ? "border-[#42578E] text-[#42578E] dark:text-blue-400 font-medium"
      ...
      ">
        <button
          onClick={onClose}
          className="
            px-6 py-2 rounded-xl flex items-center gap-2 font-medium
