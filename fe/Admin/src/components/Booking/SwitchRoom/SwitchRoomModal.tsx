    ...
    >
      <div
        className="relative w-full 
            sm:max-w-6xl max-h-[95vh] bg-white rounded-xl sm:rounded-2xl 
            shadow-2xl flex flex-col overflow-hidden"
      >
        {/* ================= HEADER ================= */}
        <div className="flex justify-between items-start px-4 sm:px-8 py-4 sm:py-6 border-b border-gray-200">
          <div>
        ...
        {!loading && booking && (
          <>
            {/* ================= BODY ================= */}
            <div className="flex-1 overflow-y-auto px-4 sm:px-8 py-4 sm:py-8 space-y-8 bg-gray-50">
              {/* ===== CURRENT BOOKING ===== */}
              <div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                  ...
                  <div className="w-full overflow-x-auto">
                    <div className="min-w-[900px]">
                      {/* ===== HEADER ===== */}
                      <div className="grid grid-cols-12 px-6 py-3 text-xs font-semibold text-gray-500 bg-gray-50 border-b border-gray-200">
                      ...
                      {booking?.details
                        ...
                        .map((d: any) => (
                          <div
                            key={d.id}
                            className="grid grid-cols-12 items-center px-6 py-4 border-b border-gray-200"
                          >
            ...
            {/* ================= FOOTER ================= */}
            <div className="px-4 sm:px-8 py-4 border-t border-gray-200 flex flex-col sm:flex-row 
