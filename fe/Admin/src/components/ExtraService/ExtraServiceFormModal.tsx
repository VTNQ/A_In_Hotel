  ...
  return (
    ...
    >
      <div className="mb-6 flex flex-col lg:items-start ">
        ...
        <div
          className="relative w-28 h-28 sm:w-32 sm:h-32 bg-[#EEF0F7] dark:bg-slate-800 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          />
          {errors.serviceName && (
            <p className="text-red-500 dark:text-red-400 mt-1">{errors.serviceName.message}</p>
          )}
        </div>
        <div>
          <label className="block mb-1 font-medium text-[#253150] dark:text-slate-200">
        ...
        <div>
          ...
          />
          {errors.extraCharge && (
            <p className="text-red-500 dark:text-red-400 mt-1">{errors.extraCharge.message}</p>
          )}
        </div>
