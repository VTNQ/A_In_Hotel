      ...
      >
        ...
        >
          ...
          <button
            ...
            "
          >
            <X className="w-5 h-5 text-slate-500 dark:text-gray-300" />
          </button>
        </header>
        ...
        <div
          className="
            flex-1 overflow-y-auto py-8 custom-scroll
        ...
        <footer
          className="
            ...
            items-end px-4 sm:px-8 py-4 sm:py-6
            bg-white dark:bg-gray-900
            ...
            {!isLastTab ? (
              ...
              <button
                ...
                className={`
                  ...
                  px-8 h-12 rounded-lg font-semibold transition
                  ${
