...
import { BookingStatus, statusLabel, statusStyle, type BookingStatusTab } from "../type/booking.types";
              ...
              >
                ...
                <div className="p-6 grid md:grid-cols-3 gap-8">
                  ...
                  <div className="bg-[#f7f7f6] dark:bg-slate-900/50 rounded-lg p-4 border">
                    ...
                    {b.details?.filter((d:any)=>d.roomId!=null).map((room: any, i: number) => (
                ...
                <div className="px-6 py-4 border-t flex justify-end gap-3">
                  ...
                  <button  onClick={() => navigate(`/my-booking/${b.id}`)} className="px-6 h-10 rounded-lg bg-primary text-white text-sm font-bold shadow-sm hover:bg-primary/90">
                    View Details
                  </button>
                </div>
              </div>
