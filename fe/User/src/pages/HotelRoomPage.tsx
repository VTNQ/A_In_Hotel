  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/image/724ed79d34d3b1706617f9c2e66ea6c1fffec304.png')",
        }}
      >
            ...
            rooms.map((room, index) => {
              ...
              return (
                <div key={room.id} className="relative">
                  ...
                  {/* CARD */}
                  <div
                    className={`bg-[#F6F3F0] p-6 sm:p-8 lg:p-10 mt-6
                                            lg:mt-0
                                            lg:absolute 
                                            lg:top-1/2 
                                            lg:-translate-y-1/2 
                  ...
                  >
                    <h3 className="mb-4 text-xl sm:text-2xl font-montserrat font-normal  text-[#2f2a25]">
                      {room.name}
                    </h3>

                    <p className="mb-6 text-sm font-montserrat leading-relaxed text-gray-600 line-clamp-3">
                      {room.description}
                    </p>

                    {/* FEATURES */}
                    <ul
                      className="mb-6 grid grid-cols-2 sm:grid-cols-3 gap-y-3 
                                        gap-x-4 text-sm text-gray-700"
                    >
                    ...
                    <div
                      className="flex flex-col sm:flex-row sm:items-center sm:justify-between
                                        gap-4 border-t border-[#E4DBD1] pt-4"
                    >
                      <a
                        href="#"
