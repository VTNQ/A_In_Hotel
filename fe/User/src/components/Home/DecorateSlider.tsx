...
const images = [
  ...
  "https://images.unsplash.com/photo-1517840901100-8179e982acb7?q=80&w=1200",
...
const DecorateSlider = () => {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-[#fff7f0] overflow-hidden">
      ...
      {/* SLIDER */}
      <div className="relative h-[380px] sm:h-[460px] lg:h-[560px] flex justify-center items-center">
        {SLIDES.map((img, i) => {
          const pos = i - current;
