      ...
      {!loading && booking && (
        <>
          ...
          >
            {/* CURRENT BOOKING */}
            <div>
              <h2 className="font-semibold mb-4 text-gray-900 dark:text-neutral-100">
                ...
                {booking?.details
                  ...
                  .map((d: any) => (
                    <div
                      ...
                      "
                    >
                      <div className="col-span-2 font-bold text-gray-900 dark:text-neutral-100">
                        {d.roomNumber}
                      </div>

                      <div className="col-span-2 text-gray-700 dark:text-neutral-300">
                        {d.roomType}
                      </div>

                      <div className="col-span-2 text-gray-500 dark:text-neutral-400">
            ...
            <div
              ...
              "
            >
              <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-neutral-800">
                {/* CONFIRM */}
                <div className="p-6">
                  <h3
                    className="
                ...
                {/* PRICE IMPACT */}
                <div className="p-6 bg-gray-50/50 dark:bg-neutral-950/40">
                  <h3
                    className="
                      text-xs font-semibold uppercase tracking-wider mb-4
                      text-gray-500 dark:text-neutral-400
