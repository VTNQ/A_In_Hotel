...
const SectionHeader = ({ title, icon }: SectionHeaderProps) => {
  return (
    <div className="flex items-center gap-3 mb-4 sm:mb-5 min-w-0">
      ...
      rounded-lg bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/50 shrink-0">
        {icon}
      </div>
      <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-neutral-100 truncate">
        {title}
      </h3>
    </div>
  );
