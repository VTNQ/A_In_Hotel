...
const CreateVoucherPage = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex-1 overflow-y-auto p-8 grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white border">
        {/* ================= LEFT ================= */}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <SelectField
                    isRequired={true}
                    items={[
                      { value: "1", label: t("bookingDateTime.packageDayUse") },
                      {
                        value: "2",
      ...
      <div className="flex justify-end gap-3 border-t pt-4">
        <Button variant="outline" onClick={()=>navigate("/Home/coupon/voucher")}>{t("common.cancel")}</Button>
        <Button
